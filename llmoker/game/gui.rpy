...
init python:
    gui.init(llmoker_gui_width, llmoker_gui_height)
...
define gui.text_font = "fonts/malgun.ttf"
...
define gui.namebox_width = 292
define gui.namebox_height = 66
...
define config.thumbnail_height = 115
